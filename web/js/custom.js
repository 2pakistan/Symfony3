...
$(document).ready(function() {
    //INITIALISATION DATEPICKER. (format, french languauge, today date selected et pastDays unselectable;
    ...
    //Open datepicker on click glyphicon calendar
    $('#btnDatePicker').on("click",function(e){
        e.preventDefault();
        $('.js-datepicker').datepicker("show");
    })

    //Focus on field title on new voyage page
    $('.title-new-trip').focus();
